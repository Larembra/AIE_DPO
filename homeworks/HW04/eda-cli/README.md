...
К существующему CLI-приложению для EDA добавлен **HTTP-сервис на FastAPI** с эндпоинтами `/health`, `/quality`, `/quality-from-csv`, `/quality-flags-from-csv`.  
...
### 5. `POST /quality-flags-from-csv` – все флаги оценки качества по CSV-файлу
